    ...
    <>
      ...
      <div className="bodybg min-h-screen pt-10">
            <h1 className="titulo text-white text-2xl md:text-4xl font-bold pt-5 text-center ">
              Inicia sesión y <span className="text-black">Administra tus Cuentas</span> para que no las olvides o si ya no las recuerdas <span className="text-black">Las recuperes</span>
            </h1>
